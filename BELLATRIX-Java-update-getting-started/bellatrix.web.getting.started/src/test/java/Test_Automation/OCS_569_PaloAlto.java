...
public class OCS_569_PaloAlto extends OCS_Main{
    ...
    @Test
    public void multipleHostnamePaloAlto() throws InterruptedException, IOException {
        ...
        //party id , etc."
        openDiscoveryQueue();
        String PaloAltoPayLoad = discoveryPaloAlto(table_name,
                ip, mac, serialNo, paloAltoThirdParty);
        String jsonString = restApiExplorer(PaloAltoPayLoad);
        ...
        String PaloAltoPayLoadNoMac = discoveryPaloAlto(table_name,
                ip, macUpdated, serialNo, paloAltoThirdParty);
        String QueueRecordNoMac = extractQue(restApiExplorer(PaloAltoPayLoadNoMac));
        ...
        //other things same as above"
        String PaloAltoPayLoadNoIp = discoveryPaloAlto(table_name,
                ipUpdated, macUpdated, serialNo, paloAltoThirdParty);
        String QueueRecordNoIp = extractQue(restApiExplorer(PaloAltoPayLoadNoIp));
        ...
        //other things same as above"
        String PaloAltoPayLoadNoHostSerial = discoveryPaloAlto(table_name,
                ipUpdated, macUpdated, serialNoUpdated, paloAltoThirdParty);
        String QueueRecordNoHostSerial = extractQue(restApiExplorer(PaloAltoPayLoadNoHostSerial));
